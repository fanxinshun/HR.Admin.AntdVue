    ...
    <a-spin :spinning="loading">
      <a-form-model ref="ruleForm" :model="ruleForm" :rules="rules" v-bind="layout">
        ...
        <a-form-model-item label="测评模版" prop="assessment_template_id">
          <c-select v-model="ruleForm.assessment_template_id" v-if="hackReset" url="/HrAssessment/GetOptionList" searchMode="server" :disableds="type === 'view'" suffixIcon="search" @handleInput="getAssessment_template"></c-select>
        </a-form-model-item>
        <a-form-model-item label=" 测评对象" prop="user_id">
          <c-select v-model="ruleForm.user_id" v-if="hackReset" url="/Base_Manage/Base_User/GetUserOptionList" searchMode="server" :disableds="type === 'view'" suffixIcon="search" @handleInput="getUser_id"></c-select>
        </a-form-model-item>
        <a-form-model-item label="用人部门负责人" prop="department">
          <c-select v-model="ruleForm.department" v-if="hackReset" url="/Base_Manage/Base_User/GetUserOptionList" :multiple="true" searchMode="server" :disableds="type === 'view'" suffixIcon="search" @handleInput="getDepartment"></c-select>
        </a-form-model-item>
        <a-form-model-item label="同职级测评人" prop="withEvaluation">
          <c-select v-model="ruleForm.withEvaluation" v-if="hackReset" url="/Base_Manage/Base_User/GetUserOptionList" :multiple="true" searchMode="server" :disableds="type === 'view'" suffixIcon="search" @handleInput="getEvaluation"></c-select>
        </a-form-model-item>
        <a-form-model-item label="下级测评人" prop="lowerEvaluation">
          <c-select v-model="ruleForm.lowerEvaluation" v-if="hackReset" url="/Base_Manage/Base_User/GetUserOptionList" :multiple="true" searchMode="server" :disableds="type === 'view'" suffixIcon="search" @handleInput="getLowerEvaluation"></c-select>
        </a-form-model-item>
        <a-form-model-item label="HR部门负责人" prop="hrDepartment">
          <c-select v-model="ruleForm.hrDepartment" v-if="hackReset" url="/Base_Manage/Base_User/GetUserOptionList" :multiple="true" searchMode="server" :disableds="type === 'view'" suffixIcon="search" @handleInput="getHrDepartment"></c-select>
        </a-form-model-item>
      </a-form-model>
    </a-spin>
  </a-modal>
