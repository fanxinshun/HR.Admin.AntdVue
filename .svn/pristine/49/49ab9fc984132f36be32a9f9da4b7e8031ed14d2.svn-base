...
namespace Coldairarrow.Util
{
    public static partial class Extention
    {
        ...
        /// <returns></returns>
        public static string ToRealPath(this string str)
        {
            return str.IsNullOrEmpty() ? str : ConfigHelper.GetValue("FastDFS:FileRootUrl") + str;
        }
        /// <summary>
        /// 转为相对路径
        /// </summary>
        ...
        {
            return str.Replace(ConfigHelper.GetValue("FastDFS:FileRootUrl"), string.Empty);
        }
